...
class TestFriends < MiniTest::Test
  ...
  def test_likes_to_eat_false
    result = likes_to_eat(@person2, "nuts")
    assert_equal(false, result)
  end

  def test_likes_to_eat_true_2
  ...
  def test_everyone_favourite_foods
    result = everyone_favourite_foods(@people)
